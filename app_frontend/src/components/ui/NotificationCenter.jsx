       ...
       <div className={`flex flex-col h-full rounded-2xl shadow-2xl border ${t.modalBg}`}>
          <div className="flex items-center justify-between p-4 border-b border-white/10">
             ...
             <div className="flex items-center gap-2">
                ...
                <button onClick={onClose} className="p-1 rounded-lg hover:bg-white/5 text-slate-500 transition-colors"><X className="w-4 h-4" /></button>
             </div>
          </div>
                   ...
                   {notifications.map(n => {
                      ...
                      return (
                         <div 
                           ...
                           className={`p-3 rounded-xl transition-all cursor-pointer relative group ${n.read ? 'opacity-60' : `${t.hover} bg-white/5`}`}
                         >
