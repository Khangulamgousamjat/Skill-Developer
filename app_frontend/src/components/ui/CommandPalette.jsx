        ...
        <div className="max-h-[60vh] overflow-y-auto p-2 custom-scrollbar">
          {loading ? (
            ...
            <div className="py-8 px-4 text-center">
              ...
              <p className={`text-xs mt-1 ${t.textMuted}`}>Use <kbd className="font-mono bg-white/5 px-1 rounded">Ctrl+K</kbd> anytime to open this menu.</p>
        ...
        <div className="p-3 border-t border-white/10 bg-black/20 flex justify-between items-center">
          ...
          <div className="flex gap-4">
             <div className="flex items-center gap-1.5">
                <kbd className="font-mono bg-white/5 border border-white/10 px-1 rounded text-[10px] text-slate-400">⏎</kbd>
