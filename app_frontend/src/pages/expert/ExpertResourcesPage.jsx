          ...
          {resources.length === 0 ? (
            ...
            <div key={asset.id} className={`p-8 rounded-[40px] border relative group glare-hover transition-all ${t.card} ${t.borderSoft}`}>
               <div className="flex justify-between items-start mb-6">
                  <div className="w-14 h-14 rounded-2xl bg-white/5 flex items-center justify-center border border-white/5 transition-transform duration-500 group-hover:scale-110">
               ...
               <div className="flex items-center justify-between">
                  <span className={`px-2.5 py-0.5 rounded-lg text-[9px] font-black uppercase bg-white/5 border border-white/10 ${t.textMuted}`}>
                    {asset.type}
                  </span>
                  <a 
                    href={asset.url} target="_blank" rel="noreferrer"
                    className="flex items-center gap-2 px-6 py-2 rounded-xl bg-white/5 border border-white/5 text-[10px] font-black uppercase tracking-widest text-slate-400 hover:text-white hover:bg-emerald-600 transition-all group"
                  >
              ...
              <form onSubmit={handleSubmit} className="bottom-space-5 space-y-5">
                 <div className="space-y-2">
                    ...
                    <input 
                      ...
                      className={`w-full px-5 py-3 rounded-2xl bg-white/5 border ${t.borderSoft} text-sm focus:ring-2 focus:ring-emerald-500 outline-none transition-all`}
                    />
                 </div>
                 <div className="space-y-2">
