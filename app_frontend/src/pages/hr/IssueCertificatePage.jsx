    ...
    <div className="space-y-6 animate-fade-in pb-10">
      <div className="flex justify-between items-center">
        ...
        <div className="flex gap-2">
           <button className={`p-2 rounded-xl border ${t.borderSoft} ${t.textMuted} hover:bg-white/5`}>
        ...
        <div className={`lg:col-span-1 rounded-3xl p-6 border ${t.card} ${t.borderSoft}`}>
          <div className="relative mb-6">
             ...
             <input
               ...
               className={`w-full pl-10 pr-4 py-2.5 rounded-xl text-sm border focus:ring-2 focus:ring-amber-500/50 outline-none transition-all ${isDarkMode ? 'bg-white/5 border-white/10 text-white' : 'bg-white border-gray-200 text-slate-800'}`}
             />
          </div>
          ...
          <div className="space-y-2 max-h-[500px] overflow-y-auto pr-2 custom-scrollbar">
            {filtered.map(intern => (
              ...
              >
                <div className={`w-10 h-10 rounded-xl flex items-center justify-center font-bold text-xs ${form.internId === intern.id ? 'bg-amber-500 text-white' : (isDarkMode ? 'bg-white/10 text-slate-400' : 'bg-gray-100 text-slate-500')}`}>
                ...
                <div className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <select
                      ...
                      className={`w-full p-4 rounded-2xl text-sm border focus:ring-2 focus:ring-amber-500/50 outline-none transition-all ${isDarkMode ? 'bg-white/5 border-white/10 text-white' : 'bg-gray-50 border-gray-200 text-slate-800'}`}
                    >
