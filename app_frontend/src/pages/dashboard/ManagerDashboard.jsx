               ...
               >
                ...
                <div className="space-y-6 animate-fade-in w-full">
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div className={`p-4 rounded-2xl border flex flex-col gap-1 transition-transform hover:-translate-y-1 ${isDarkMode ? 'bg-white/5 border-white/5' : 'bg-white border-emerald-100 shadow-sm'}`}>
