                ...
                <div className="space-y-4 animate-fade-in w-full">
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                        {advice.suggestions.map((topic, i) => (
                            <div key={i} className={`p-4 rounded-2xl border flex items-center gap-3 transition-transform hover:-translate-y-1 ${isDarkMode ? 'bg-white/5 border-white/5' : 'bg-white border-blue-100 shadow-sm'}`}>
