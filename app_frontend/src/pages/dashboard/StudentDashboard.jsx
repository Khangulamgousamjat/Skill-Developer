    ...
    <div className="space-y-6 animate-fade-in">
      ...
      <div className={`p-8 rounded-[40px] border relative overflow-hidden group ${t.card}`}>
         ...
         <div className="relative z-10 flex flex-col md:flex-row items-center gap-8">
            ...
            <div className="flex-1 space-y-3 w-full">
               ...
               <div className="h-4 w-full bg-white/5 border border-white/5 rounded-full overflow-hidden">
                  <div 
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className={`p-8 rounded-[40px] relative overflow-hidden group ${t.card} border ${t.borderSoft}`}>
            ...
            {studentOverview.nextLecture ? (
                ...
                <div className="py-10 text-center bg-white/3 rounded-[32px] border border-dashed border-white/5">
            ...
            <div className="flex gap-4 mb-8">
               {studentOverview.recentBadges?.length > 0 ? studentOverview.recentBadges.map((badge, idx) => (
                 ...
                 <div className="flex gap-4">
                    {[1,2,3].map(i => (
                       <div key={i} className="w-16 h-16 rounded-2xl bg-white/5 border border-dashed border-white/10 flex items-center justify-center opacity-50">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 mb-8">
         <div className={`lg:col-span-8 p-8 rounded-[40px] ${t.card} border ${t.borderSoft}`}>
            ...
            <div className="h-48 flex items-center justify-center bg-white/3 rounded-3xl border border-dashed border-white/5">
